...
//6
const printBookInfo = function({title, author, year="Year Unknown"} = books[0]){
...
const {publisher: bookPublisher, ...restOfTheBook} = books[1];console.log(bookPublisher, restOfTheBook);
